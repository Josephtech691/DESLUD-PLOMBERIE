...
const projects = [
  ...
  { id: 3, cat: 'installation', before: '/images/install2b.jpeg', after: '/images/install2a.jpeg', title_fr: 'Installation douche moderne', title_en: 'Modern shower installation', loc: 'Melen, Yaoundé' },
  { id: 4, cat: 'entretien', before: '/images/entre1b.jpg', after: '/images/entr1a.jpg', title_fr: 'Entretien réseau complet', title_en: 'Full network maintenance', loc: 'Mvog-Ada, Yaoundé' },
